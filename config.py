...
_C.PATH = CN()
_C.PATH.TRAIN_FOLDER = '../Data/avenue/training/frames'
_C.PATH.TEST_FOLDER = '../Data/avenue/testing/frames'
_C.PATH.FRAME_MASK = './data/annotations/avenue.json'
...
def update_config(config, args):
    if args.dataset == 'ped2':
        args.cfg = 'configs/vit_base/ped2__vit_base__img224.yaml'
    elif args.dataset == 'avenue':
        args.cfg = 'configs/vit_base/avenue__vit_base__img224.yaml'
    elif args.dataset == 'shanghaitech':
        args.cfg = 'configs/vit_base/shanghaitech__vit_base__img224.yaml'
    else:
